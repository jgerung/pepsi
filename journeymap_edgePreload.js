...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "journeymap_edge.js"},
      { load: "journeymap_edgeActions.js"}];
...
var plSTF="both",ctrPlS="horizontal",minPlW="400px",maxPlW="1020px",plWidth="1020px",plHeight="635px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        linkURL: "flash/index.html",
        rect: ['0', '0','1020px','635px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/preLoader.jpg','0px','0px']
    },
    {
        id: 'preloader22',
        type: 'image',
        tag: 'img',
        rect: ['641px', '607px','47px','10px','auto', 'auto'],
...
dlContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        linkURL: "indexflash.html",
        rect: ['109px', '0px','815px','507px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/a_downlevel.jpg','0px','0px']
    }]};//simpleContent
